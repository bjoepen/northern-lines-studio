...
export const PREVIEW_GOLDEN_HEIGHT = 594;
export const PREVIEW_BASE_HEIGHT = PREVIEW_BASE_WIDTH * 210 / 148;
export const PREVIEW_A5_EXTENSION = PREVIEW_BASE_HEIGHT - PREVIEW_GOLDEN_HEIGHT;
