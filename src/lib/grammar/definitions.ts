...
export const grammarDefinitions: readonly PageGrammarDefinition[] = [
  ...
  { id: 'contents', name: 'Contents', purpose: 'Gibt automatisch Orientierung, ohne den ruhigen Editorial Rhythm zu verlassen.', story: [required('title', 'Titel')], editorialFrame: frame },
  ...
  { id: 'notes', name: 'Notes', purpose: 'Lässt als kuratierte Schreibseite bewusst Raum für eigene Beobachtungen, Motive und Erinnerungen.', story: [required('title', 'Titel')], editorialFrame: frame },
