...
must(app.includes('requireCompanionLayout(editorialWorld.layoutSystemId.replace'), 'App does not resolve Companion layout from the active World contract');
...
must(app.includes('class={worldPageClass}'), 'A5 page does not receive the dynamic World class');
